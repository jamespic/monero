...
ENTRYPOINT ["monerod", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18090", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18091", "--non-interactive", "--confirm-external-bind"]
