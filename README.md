...
* Docker
        ...
        docker run -it -v /monero/chain:/root/.monero-legacy -v /monero/wallet:/wallet -p 18090:18090 monero

        # or in background
        docker run -it -d -v /monero/chain:/root/.monero-legacy -v /monero/wallet:/wallet -p 18090:18090 monero
